...
class Spinner28 extends Component {
    ...
    render() {
        ...
        return (
            <Style>
                ...
                `}
                <div className="spinner28-container">
                    <div className="spinner28-dot1" />
                    <div className="spinner28-dot2" />
                    <div className="spinner28-dot3" />
                    <div className="spinner28-dot4" />
                </div>
            </Style>
        );
    };
