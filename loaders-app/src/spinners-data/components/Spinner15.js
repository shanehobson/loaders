...
class Spinner15 extends Component {
    ...
    render() {
        ...
        return (
            <Style>
                ...
                `}
                <div className="spinner15"><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div></div>
            </Style>
        );
    };
}
  
export default Spinner15;